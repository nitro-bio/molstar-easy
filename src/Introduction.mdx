...
# or yarn add @nitro-bio/molstar-easy
# or pnpm i @nitro-bio/molstar-easy
```
...
Once you've done so, add `@nitro-bio/molstar-easy` to your `tailwind.config.js` file:

```js
  content: [
    "...",
    "node_modules/@nitro-bio/molstar-easy/dist/**/*.{js,ts,jsx,tsx}",
  ],
```
...
```js
import "path/to/node_modules/@nitro-bio/molstar-easy/dist/nitro.css";
```
